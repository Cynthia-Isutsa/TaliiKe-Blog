  ...
  return (
    <div>
      ...
      <div className={`bg-[#4B6BFB]/[5%] rounded-xl w-full h-[200px]`}>
          <h1 className= 'text-4xl md:text-7xl lg:pt-9 font-bold text-center'>Want to inquire anything?</h1>
      </div>
      <div className='container mt-5 flex flex-col items-center' >
        ...
        <form className='flex flex-col mt-8'  action="https://getform.io/f/7b4a482d-0007-43e5-8949-20f63e7fd26c" method='POST' encType='multipart/form-data'>
          ...
          className="border-hidden outline-none bg-gray-200 pl-2 pr-[400px] py-3 my-2" />
